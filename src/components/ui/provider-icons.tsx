// ============================================================
// Provider Brand Icons — official provider logos as inline SVG
// ============================================================
// Paths sourced from simple-icons (CC0). Rendered with
// currentColor so they inherit theme text colors.

interface BrandIconProps {
  className?: string;
  size?: number;
  /** Use the provider's real brand color instead of currentColor */
  brandColor?: boolean;
}

export function GoogleDriveIcon({ className, size = 16, brandColor = false }: BrandIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
      ...
      height={size}
      className={className}
      fill={brandColor ? "url(#intab-gdrive-grad)" : "currentColor"}
    ...
    >
      ...
      {!brandColor ? null : (
        <defs>
          <linearGradient id="intab-gdrive-grad" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#00ac47" />
            <stop offset="0.33" stopColor="#1fa463" />
            <stop offset="0.55" stopColor="#ffba00" />
            <stop offset="0.8" stopColor="#2684fc" />
...
export function OneDriveIcon({ className, size = 16, brandColor = false }: BrandIconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
      ...
      height={size}
      className={className}
      fill={brandColor ? "#0364b8" : "currentColor"}
      xmlns="http://www.w3.org/2000/svg"
      aria-label="OneDrive"
    >
